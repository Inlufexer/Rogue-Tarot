...
const BOTTOM_LEFT_CORNER: Vector2 = Vector2(192, 770)
const ROOM_SIZE: Vector2 = Vector2(160, 160)

@export var _dimensions: Vector2i = Vector2i(6, 4)
...
var dungeon : Array
var content_icons: Dictionary

func _ready():
	content_icons = {
	Contents.ENTRANCE: _room_icons[0],
	Contents.STAIRS: _room_icons[1],
	Contents.ENEMY: _room_icons[2],
	Contents.TREASURE: _room_icons[3],
	Contents.MERCHANT: _room_icons[4],
	Contents.CAMP: _room_icons[5],
	Contents.BOSS: _room_icons[6],
	Contents.RANDOM: _room_icons[7],
}
	...
	if event.is_action_pressed("ui_accept"):
		...
		for i in 3:
			...
			if randi() % 2 == 0:
				...
				content = Contents.MERCHANT
			_branches.append(content)
		_generate_dungeon()
